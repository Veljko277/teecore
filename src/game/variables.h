...
// info shown on /info
MACRO_CONFIG_STR(SvInfoGithub, sv_info_github, 128, "Github: https://github.com/Veljko277/teecore/tree/main", CFGFLAG_SERVER, "Github link shown when /info is used")
